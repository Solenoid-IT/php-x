...
{
    public function __construct (int $code = 0, string $message = '', protected ?string $type = null, protected ?int $http_code = 500, protected bool $exposed = false, protected bool $notifiable = false)
    {
